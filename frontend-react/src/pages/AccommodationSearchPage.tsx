    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-[700px] mx-auto p-4 px-6 md:px-8 pt-20">
        <h1 className="text-3xl font-bold text-gray-800 mb-4">
          Buscar alojamiento en {destino}
        </h1>
        {missing ? (
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            <p className="text-red-600 font-semibold mb-4">
              Faltan datos para generar la búsqueda. Por favor vuelve y completa
              la información.
            </p>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            ...
            <div className="mt-8 flex flex-col gap-4">
              ...
              <Button
                ...
                variant="hotels"
              >
                Buscar en Hotels.com
              </Button>
            </div>
            <div className="mt-8 text-gray-500 italic">
              (En el futuro aquí se mostrarán recomendaciones personalizadas por
              IA)
            </div>
          </div>
        )}
