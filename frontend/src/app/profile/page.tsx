...
import { profileUpdateSchema, type ProfileUpdateFormData } from '@/lib/validationSchemas';
...
export default function ProfilePage() {
  ...
  const handleInputChange = (field: keyof ProfileUpdateFormData, value: string) => {
  ...
  const getUserInitials = (user: { first_name?: string; last_name?: string; display_name?: string; username?: string }) => {
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <CardTitle className="text-2xl">{user.display_name || user.username}</CardTitle>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <p className="mt-1 text-gray-900">{user.first_name || 'Not set'}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <p className="mt-1 text-gray-900">{user.last_name || 'Not set'}</p>
                    )}
                  </div>
                </div>
                    ...
                    <div>
                      ...
                      <div className="mt-2 space-y-2">
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium">{user.total_trips_created || 0}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-sm text-gray-600">Trips Completed:</span>
                          <span className="font-medium">{user.total_trips_completed || 0}</span>
                        </div>
                      </div>
                    </div>
