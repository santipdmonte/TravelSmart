...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  grainUrl = '/texture/noisy-background.jpg',
  behindGradient,
  innerGradient,
  ...
  const sizeClass = useMemo(() => {
    if (size === 'sm') return 'pc-size-sm';
    if (size === 'lg') return 'pc-size-lg';
    return 'pc-size-md';
  }, [size]);

  return (
    <div ref={wrapRef} className={`pc-card-wrapper ${sizeClass} ${className}`.trim()} style={cardStyle}>
